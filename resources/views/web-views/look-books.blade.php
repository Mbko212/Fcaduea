            ...
            <div class="row">
                ...
                @if(count($look_books) > 0)
                    @foreach($look_books as $key => $look_book)
                        @if($look_book->id == 1)
                            <div class="col-sm-6">
                                <img class="img-fluid cv1x" onerror="this.src='{!! asset('public/assets/front-end/img/image-place-holder.png') !!}'"
                                     src="{!! asset("storage/app/public/look-book/" . $look_book->banner) !!}">
                                <div class="next">
                                    <a href="{!! route('look_book_gallery', $look_book->slug) !!}">
                                        <h4>{!! $look_book->title !!} <i class="fa fa-long-arrow-right" aria-hidden="true"></i>
                                        </h4>
                                    </a>
                                </div>
                            </div>
