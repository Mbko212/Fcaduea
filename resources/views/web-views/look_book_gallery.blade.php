...
@section('title', ucwords($look_book->title))
...
@section('content')
    <div class="container sec-filter">
        <h2>{!! ucwords($look_book->title) !!}</h2>
    </div>
    <div class="container grid-container imgx">
        <div class="grid-row">
            @foreach($look_book->gallery as $key => $images)
                <div class="item">
                <img src="{!! asset("storage/app/public/look-book/gallery") .'/'. $images['image'] !!}"
                     onerror="this.src='{!! asset('public/assets/front-end/img/image-place-holder.png') !!}'" />
            </div>
            @endforeach
{{--            <div class="item">--}}
{{--                <img src="https://picsum.photos/400/800/?random" alt="" />--}}
{{--            </div>--}}
{{--            <div class="item">--}}
{{--                <img src="https://picsum.photos/400/?random" alt="" />--}}
{{--            </div>--}}
{{--            <div class="item">--}}
{{--                <img src="https://picsum.photos/400/600/?random" alt="" />--}}
{{--            </div>--}}
{{--            <div class="item">--}}
{{--                <img src="https://picsum.photos/400/300/?random" alt="" />--}}
{{--            </div>--}}
{{--            <div class="item">--}}
{{--                <img src="https://picsum.photos/400/700/?random" alt="" />--}}
{{--            </div>--}}
{{--            <div class="item">--}}
{{--                <img src="https://picsum.photos/400/250/?random" alt="" />--}}
{{--            </div>--}}
{{--            <div class="item">--}}
{{--                <img src="https://picsum.photos/400/450/?random" alt="" />--}}
{{--            </div>--}}
{{--            <div class="item">--}}
{{--                <img src="https://picsum.photos/400/550/?random" alt="" />--}}
{{--            </div>--}}
{{--            <div class="item">--}}
{{--                <img src="https://picsum.photos/400/310/?random" alt="" />--}}
{{--            </div>--}}
{{--            <div class="item">--}}
{{--                <img src="https://picsum.photos/400/310/?random" alt="" />--}}
{{--            </div>--}}
        ...
        <div class="row">
            <a href="{!! route('look-books') !!}" class="btnx-1 look-back">Back To Look
                Book's</a>
        </div>
    </div>
    <!-- END BOX-1 -->

    @if(count($look_book->products)>0)
    <div class="container sec-filter">
        <h2>Saw Something you liked?</h2>
    </div>
    <div class="container">
        <div class="row">
            @foreach($look_book->products as $key => $product)
                <div class="col-sm-3">
                    <div class="acess-box">
