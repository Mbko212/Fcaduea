...
{{--                                <option--}}
{{--                                    value="processing" {{$order->order_status == 'processing'?'selected':''}} >{{trans('messages.Processing')}} </option>--}}
                                <option
                                ...
                                <option
                                    value="canceled" {{$order->order_status == 'canceled'?'selected':''}} > {{trans('messages.Canceled')}}</option>
{{--                                <option--}}
