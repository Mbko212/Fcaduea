                        ...
                        <div class="card-body">
                            <div class="lang_form" id="form">
                                ...
                                <div class="form-group pt-4">
                                    ...
                                    <textarea name="details" style="display:none" class="textarea"
...
{{--                                    </div>--}}
                    ...
                    <div class="card mt-2 rest-part d-none">
                        <div class="card-header">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-1" style="padding-top: 30px;margin-left: -20px;">
                                        <select
                                            ...
                                            name="discount_type">
                                            <option
                                                value="percent" {{$product['discount_type']=='percent'?'selected':''}}>{{trans('messages.Percent')}}</option>
                                            <option
                                                value="flat" {{$product['discount_type']=='flat'?'selected':''}}>{{trans('messages.Flat')}}</option>
