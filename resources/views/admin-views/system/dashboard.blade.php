...
{{--                        <p>Welcome admin, here is your business statistics.</p>--}}
                        <p>Hi {!! auth('admin')->user()->name !!}. Here is your business statistics</p>
                    </div>
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-md-4 col-12 graph-border-1">
                                    ...
                                    <span class="h6 mb-0">
                                        ...
                                        Earning : {{\App\CPU\BackEndHelper::set_symbol(\App\CPU\BackEndHelper::usd_to_currency(array_sum($inhouse_data)))}}
                                    </span>
                                    </div>
                                </div>
{{--                                <div class="col-md-4 col-12 graph-border-1">--}}
...
{{--                                         Seller Earnings : {{\App\CPU\BackEndHelper::set_symbol(\App\CPU\BackEndHelper::usd_to_currency(array_sum($seller_data)))}}--}}
{{--                                    </span>--}}
{{--                                    </div>--}}
{{--                                </div>--}}
{{--                                <div class="col-md-4 col-12 graph-border-1">--}}
...
{{--                                        Commission Earned : {{\App\CPU\BackEndHelper::set_symbol(\App\CPU\BackEndHelper::usd_to_currency(array_sum($commission_data)))}}--}}
{{--                                    </span>--}}
{{--                                    </div>--}}
{{--                                </div>--}}
                            </div>
...
{{--                        <h3 class="text-center" style="color: gray">Hi {{auth('admin')->user()->name}}, Welcome to your dashboard.</h3>--}}
{{--                    </div>--}}
{{--                </div>--}}
{{--            </div>--}}
{{--            <!-- End Page Header -->--}}
