...
@section('title','Shipping And Exchange')
    ...
    <div class="content container-fluid">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item" aria-current="page">{{trans('messages.shipping_and_exchange')}}</li>
            </ol>
        </nav>
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row justify-content-between pl-4 pr-4">
                            <div>
                                <h2>{{trans('messages.shipping_and_exchange')}}</h2>
                            </div>
                        </div>
                    </div>
                    ...
                    <form action="{!! route('admin.business-settings.shipping-and-exchange') !!}" method="post">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                <div class="col-md-12">
                                    <label for="editor">{{trans('messages.shipping_and_exchange')}}</label><textarea
