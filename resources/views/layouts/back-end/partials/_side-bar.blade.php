...
{{--                                <span--}}
{{--                                    class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{trans('messages.blog')}}</span>--}}
{{--                            </a>--}}
{{--                        </li>--}}
                        <!--blogs management ends-->
...
{{--                                </a>--}}
{{--                            </li>--}}
{{--                            <li class="navbar-vertical-aside-has-menu {{Request::is('admin/lookbook/view')?'active':''}}">--}}
{{--                                <a class="js-navbar-vertical-aside-menu-link nav-link"--}}
{{--                                   href="{{route('admin.lookbook.view')}}">--}}
                    ...
                    <!--Newsletter section here-->
                        <li class="nav-item {{Request::is('admin/newsletter')?'active':''}}">
                            <a class="nav-link " href="{{route('admin.newsletter.list')}}">
                                <span class="tio-poi-user nav-icon"></span>
                                <span
                                    class="text-truncate">{{trans('messages.newsletter_section')}} </span>
                            </a>
                        </li>
                    <!--Newsletter section ends here-->

                        @if(\App\CPU\Helpers::module_permission_check('support_section'))
{{--                            <li class="nav-item {{(Request::is('admin/support-ticket*') || Request::is('admin/contact*') || Request::is('admin/request-an-item*'))?'scroll-here':''}}">--}}
...
{{--                            <li class="navbar-vertical-aside-has-menu {{Request::is('admin/request-an-item*')?'active':''}}">--}}
{{--                                <a class="js-navbar-vertical-aside-menu-link nav-link"--}}
{{--                                   href="{{route('admin.request-an-item.list')}}">--}}
{{--                                    <i class="tio-filter-list nav-icon"></i>--}}
{{--                                    <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">--}}
{{--                                    {{trans('messages.item_request')}}--}}
{{--                                </span>--}}
{{--                                </a>--}}
{{--                            </li>--}}

{{--                            <li class="navbar-vertical-aside-has-menu {{Request::is('admin/consignments*')?'active':''}}">--}}
{{--                                <a class="js-navbar-vertical-aside-menu-link nav-link"--}}
{{--                                   href="{{route('admin.consignments.list')}}">--}}
{{--                                    <i class="tio-archive nav-icon"></i>--}}
{{--                                    <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">--}}
{{--                                    {{trans('messages.consignments')}}--}}
{{--                                </span>--}}
{{--                                </a>--}}
{{--                            </li>--}}
...
{{--                                </a>--}}
{{--                            </li>--}}
{{--                            <li class="navbar-vertical-aside-has-menu {{Request::is('admin/business-settings/shipping-method*')?'block':'none'}}">--}}
{{--                                <a class="js-navbar-vertical-aside-menu-link nav-link"--}}
...
{{--                                    <li class="nav-item {{Request::is('admin/business-settings/pull')?'active':''}}">--}}
{{--                                        <a class="nav-link" href="{{route('admin.business-settings.pull')}}">--}}
{{--                                            <span class="tio-circle nav-indicator-icon"></span>--}}
{{--                                            <span class="text-truncate">--}}
{{--                                              {{trans('messages.pull')}}--}}
{{--                                            </span>--}}
{{--                                        </a>--}}
{{--                                    </li>--}}
{{--                                    <li class="nav-item {{Request::is('admin/business-settings/shipping-and-exchange')?'active':''}}">--}}
{{--                                        <a class="nav-link" href="{{route('admin.business-settings.shipping-and-exchange')}}">--}}
{{--                                            <span class="tio-circle nav-indicator-icon"></span>--}}
{{--                                            <span class="text-truncate">--}}
{{--                                              {{trans('messages.shipping_and_exchange')}}--}}
{{--                                            </span>--}}
{{--                                        </a>--}}
{{--                                    </li>--}}
