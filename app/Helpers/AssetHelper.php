...
{
    return asset('public/assets/front/css/' . $file);
}
...
{
    return asset('public/assets/front/images/' . $file);
}
...
{
    return asset('public/assets/front/js/' . $file);
}
...
function productImage($folderName='',$file = ''){
    return asset('storage/app/public/product'.$folderName.'/'.$file);
}
