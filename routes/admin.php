...
Route::group(['namespace' => 'Admin', 'prefix' => 'admin', 'as' => 'admin.'], function () {
    ...
    Route::group(['middleware' => ['admin']], function () {
        ...
        Route::group(['prefix' => 'blog-category', 'as' => 'blog-category.', 'middleware'=>['module:blog_management']], function () {
            ...
            Route::get('delete/{id}', 'BlogCategoryController@destroy')->name('delete');
        });

        Route::group(['prefix' => 'blog', 'as' => 'blog.', 'middleware'=>['module:blog_management']], function () {
            Route::get('list', 'BlogController@index')->name('index');
            Route::get('add-new', 'BlogController@create')->name('add-new');
            ...
            Route::post('published', 'BlogController@published')->name('published');
        });

        Route::group(['prefix' => 'category', 'as' => 'category.','middleware'=>['module:product']], function () {
        ...
        Route::group(['prefix' => 'sub-category', 'as' => 'sub-category.','middleware'=>['module:product']], function () {
...
//        Route::group(['prefix' => 'sub-sub-category', 'as' => 'sub-sub-category.','middleware'=>['module:product']], function () {
...
//        });
        ...
        Route::group(['prefix' => 'brand', 'as' => 'brand.','middleware'=>['module:product']], function () {
        ...
        Route::group(['prefix' => 'attribute', 'as' => 'attribute.','middleware'=>['module:product']], function () {
        ...
        Route::group(['prefix' => 'newsletter', 'as' => 'newsletter.'], function () {
            Route::get('list', 'NewsletterController@index')->name('list');
            Route::get('delete', 'NewsletterController@destroy')->name('delete');
        });
        ...
        Route::group(['prefix' => 'report', 'as' => 'report.'], function () {
            ...
            Route::post('ips-filter', 'InhouseProductSaleController@filter')->name('ips-filter');
            //sale report seller
            Route::get('seller-product-sale', 'SellerProductSaleReportController@index')->name('seller-product-sale');
            Route::post('sps-filter', 'SellerProductSaleReportController@filter')->name('sps-filter');
        ...
        Route::group(['prefix' => 'sellers', 'as' => 'sellers.','middleware'=>['module:user_section']], function () {
            ...
            Route::get('view/{id}', 'SellerController@view')->name('view');
        ...
        Route::group(['prefix' => 'lookbook', 'as' => 'lookbook.','middleware'=>['module:marketing']], function () {
            Route::get('view', 'LookBookController@index')->name('view');
            Route::post('store', 'LookBookController@store')->name('store');
            Route::post('status', 'LookBookController@status')->name('status');
            Route::get('edit/{id}', 'LookBookController@edit')->name('edit');
            Route::post('update/{id}', 'LookBookController@update')->name('update');
            Route::get('add-product/{id}', 'LookBookController@add_product')->name('add-product');
            Route::post('add-product/{id}', 'LookBookController@add_product_submit')->name('add-product');
            Route::get('delete-product/{look_book_id}/{product_id}', 'LookBookController@delete_product')->name('delete-product');
            Route::get('gallery/{id}', 'LookBookController@look_book_gallery')->name('look_book_gallery');
            Route::post('gallery/{id}', 'LookBookController@add_look_book_gallery')->name('look_book_gallery');
            Route::get('remove-image/{id}', 'LookBookController@remove_image')->name('gallery_image_remove');
        });

        Route::group(['prefix' => 'flashDeal', 'as' => 'flashDeal.','middleware'=>['module:marketing']], function () {
...
//            Route::post('about-us', 'BusinessSettingsController@about_usUpdate')->name('about-update');
            ...
            Route::get('pull', 'BusinessSettingsController@pull')->name('pull');
            Route::post('pull', 'BusinessSettingsController@pull_update')->name('pull');
            Route::get('shipping-and-exchange', 'BusinessSettingsController@shipping_and_exchange')->name('shipping-and-exchange');
            Route::post('shipping-and-exchange', 'BusinessSettingsController@shipping_and_exchange_update')->name('shipping-and-exchange');
            ...
            Route::group(['prefix' => 'shipping-method', 'as' => 'shipping-method.','middleware'=>['module:business_settings']], function () {
                Route::get('/', 'ShippingMethodController@index_admin')->name('by.admin');
...
//            });
        ...
        Route::group(['prefix' => 'orders', 'as' => 'orders.','middleware'=>['module:order']], function () {
...
//            Route::post('contact-store', 'ContactController@store')->name('store');
        ...
        Route::group(['prefix' => 'request-an-item', 'as' => 'request-an-item.', 'middleware'=>['module:support_section']], function () {
            Route::get('list', 'RequestAnItemController@list')->name('list');
        });

        Route::group(['prefix' => 'consignments', 'as' => 'consignments.', 'middleware'=>['module:support_section']], function () {
            Route::get('list', 'ConsignmentController@list')->name('list');
        });

        Route::group(['prefix' => 'contact', 'as' => 'contact.','middleware'=>['module:web_&_app_settings']], function () {
            Route::get('list', 'ContactController@list')->name('list');
        });
    });
